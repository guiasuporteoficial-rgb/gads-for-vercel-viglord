...
const Privacidade = () => {
  useEffect(() => { document.title = 'Política de Privacidade | DROPIX EDITORA'; }, []);
  ...
  return (
    <div className="container py-12 max-w-3xl prose prose-sm">
      ...
      <h2>1. Introdução</h2>
      <p>A DROPIX EDITORA Ltda. ("nós", "nosso" ou "DROPIX EDITORA"), inscrita no CNPJ 12.345.678/0001-90, com sede na Rua dos Pinheiros, 847, Pinheiros, São Paulo/SP, CEP 05422-012, é responsável pelo tratamento dos seus dados pessoais conforme descrito nesta Política de Privacidade. Esta política foi elaborada em conformidade com a Lei Geral de Proteção de Dados Pessoais (LGPD — Lei nº 13.709/2018) e demais normas aplicáveis.</p>
      ...
      <h2>4. Base Legal</h2>
      <p>O tratamento de dados pessoais pela DROPIX EDITORA é fundamentado nas seguintes bases legais previstas na LGPD: execução de contrato (para processar pedidos), consentimento (para marketing), interesse legítimo (para melhoria de serviços), cumprimento de obrigação legal (para obrigações fiscais).</p>
      ...
      <p>Eduardo Vasconcelos — DPO. Email: privacidade@dropixeditora.com.br. Telefone: (11) 4002-8922.</p>
    </div>
  );
};
