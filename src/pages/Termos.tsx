...
const Termos = () => {
  useEffect(() => { document.title = 'Termos de Uso | Página Viva'; }, []);
  ...
  return (
    <div className="container py-12 max-w-3xl prose prose-sm">
      ...
      <p>Ao acessar e utilizar o site paginaviva.com.br, você concorda com estes Termos de Uso. Se não concordar, por favor não utilize nosso site. O uso continuado do site após alterações constitui aceitação dos termos modificados.</p>
      ...
      <p>A Página Viva não se responsabiliza por: interrupções temporárias do site, atrasos causados por terceiros (Correios, operadoras de pagamento), uso indevido de sua conta por terceiros, danos indiretos decorrentes do uso do site.</p>
